...
kmeans_model = joblib.load("LearnUkeKala_clustering.pkl")
tfidf_vectorizer = joblib.load("LearnUkeKala_tfidf_vectorizer.pkl")

# === Set Halaman ===
st.set_page_config(page_title="Topic Clustering - Ukulele Tuner + Learn Uke Kala", layout="wide")

# === Judul Aplikasi dengan Emoji Musik Netral 🎶 ===
st.title("🎶 Topic Clustering - Ukulele Tuner + Learn Uke Kala")
    ...
    if file:
        ...
        if not required_cols.issubset(df.columns):
            ...
            st.download_button(
                ...
                file_name="hasil_klaster_learn_uke_kala.csv",
                mime="text/csv"
            )
